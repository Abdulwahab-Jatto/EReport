...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Fragment Fragment1 = getSupportFragmentManager().findFragmentById(R.id.);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			switch (position) {
			case 0:
				return "Funds In";//getString(R.string.title_section1).toUpperCase(l);
			case 1:
				return "Funds Out";//getString(R.string.title_section2).toUpperCase(l);
			case 2:
				return "Report";//getString(R.string.title_section3).toUpperCase(l);
			}
			return null;
		}
	}
